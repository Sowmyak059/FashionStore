...
namespace e_CommerceStore.Controllers
{
    ...
    public class Home_LivingController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Home_LivingController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index()
        {
            var menCategory = _context.MainCategory
                ...
                .FirstOrDefault(mc => mc.Name == "Home_Living");
        ...
        public IActionResult Products(int categoryID)
        {
            var categoryHeaders = _context.CategoryHeader
                ...
                .ThenInclude(c => c.Products)
                .Where(ch => ch.MainCategory.Name == "Home_Living")
                .ToList();
